    ...
    <div style={{ display: 'flex', gap: 8 }}>
      {[0,1,2,3,4,5].map(i => (
        <input
          ...
          onPaste={handlePaste}
          style={{
            flex: 1, width: 0, height: 52, textAlign: 'center',
            border: '1.5px solid #E8E0D5', borderRadius: 10,
            background: '#F9F6F1', fontSize: 20, fontWeight: 600,
            color: '#1A1612', fontFamily: "'DM Sans', sans-serif",
...
export default function ResetPasswordPage() {
  ...
  // email pre-filled from ForgotPassword navigate state
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginBottom: 26 }}>
          {[
            ...
            <div key={i} style={{
              height: 8,
              width:  s.now ? 22 : 8,
              borderRadius: s.now ? 4 : '50%',
              background: (s.done || s.now) ? '#C8531A' : '#E8E0D5',
